...
function TabsTrigger({
  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        "inline-flex h-full flex-1 items-center justify-center gap-2 rounded-md px-3 py-1.5",
        "text-sm font-medium whitespace-nowrap transition-all duration-200",
        "text-[var(--text-muted)] hover:text-[var(--text-primary)]",
        "data-[state=active]:bg-[var(--bg-elevated)] data-[state=active]:text-[var(--text-primary)]",
        "data-[state=active]:shadow-sm data-[state=active]:border data-[state=active]:border-[var(--border-default)]",
