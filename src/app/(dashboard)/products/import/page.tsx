...
BUTTON-001,กระดุมพลาสติก ขาว,,,วัตถุดิบ,PCS,500,100,2000,0.5`
  ...
  function downloadVariantTemplate() {
    const template = `รหัสสินค้า,ชื่อสินค้า,หมวดหมู่,หน่วย,ต้นทุน,Variant SKU,สี,ไซส์,Barcode,ราคาขาย
SHIRT-001,เสื้อยืดคอกลม Basic,เสื้อ,PCS,120,SHIRT-001-WH-S,ขาว,S,8851234567890,299
SHIRT-001,เสื้อยืดคอกลม Basic,เสื้อ,PCS,120,SHIRT-001-WH-M,ขาว,M,8851234567891,299
SHIRT-001,เสื้อยืดคอกลม Basic,เสื้อ,PCS,120,SHIRT-001-WH-L,ขาว,L,8851234567892,299
SHIRT-001,เสื้อยืดคอกลม Basic,เสื้อ,PCS,120,SHIRT-001-BK-S,ดำ,S,8851234567893,299
